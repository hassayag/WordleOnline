...
export class Wordle extends React.Component {
    ...
    render() {
        ...
        return (_jsxs(_Fragment, { children: [_jsx(Paper, { elevation: 10, children: _jsxs(Box, { sx: {
                            width: 600,
                            marginTop: 8,
                            marginBottom: 8,
                            display: 'flex',
                            ...
                            alignItems: 'center',
                        }, children: [_jsx(Board, { wordRows: this.wordRows }), _jsx(Keyboard, { keyStates: this.letterStates, onPress: this.onKeyPress })] }) }), _jsx(Modal, { open: this.endModalOpen, onClose: () => this.setEndModalOpen(false), "aria-labelledby": "modal-modal-title", "aria-describedby": "modal-modal-description", children: _jsxs(Box, { sx: {
                            position: 'absolute',
                            top: '50%',
                            left: '50%',
                            ...
                            gap: '12px',
                            outline: 0,
                        }, children: [_jsx(Typography, { id: "modal-modal-title", children: this.gameIsWon
                                    ? 'You have won!'
                                    : `You have lost :(      The word was "${this.goalWord}"` }), _jsx(Typography, { id: "modal-modal-description", sx: { mt: 2 } }), _jsxs(Box, { sx: {
                                    display: 'flex',
                                    flexDirection: 'row',
                                    gap: 2,
                                            ...
                                            bottom: 4,
                                            left: 4,
                                        }, variant: "contained", color: "secondary", onClick: () => this.setEndModalOpen(false), children: "Close" }), _jsx(Button, { sx: {
                                            position: 'absolute',
                                            bottom: 4,
                                            right: 4,
                                        }, variant: "contained", color: "primary", onClick: () => this.setEndModalOpen(false), children: "Play Again" })] })] }) })] }));
    }
    _updateGameState() {
        const newLetterStates = Object.assign({}, this.letterStates), newWordRows = Object.assign({}, this.wordRows), row = [], currentRowChars = this.wordRows[this.rowInd], goalWordChars = this.goalWord.split('');
