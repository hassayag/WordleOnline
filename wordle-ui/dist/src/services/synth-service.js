...
class SynthService {
    ...
    getPitch(letter) {
        ...
        const quotient = Math.floor(index / this.scales.minorPent.length), remainder = index % this.scales.minorPent.length;
        const register = quotient + 2, pitch = this.scales.minorPent[remainder];
